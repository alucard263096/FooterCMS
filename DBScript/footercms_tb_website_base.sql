...
CREATE TABLE `tb_website_base` (
  ...
  `favfile` varchar(200) NOT NULL,
  `contacter` varchar(200) NOT NULL,
...
INSERT INTO `tb_website_base` VALUES (1,'aa','14113007041Hydrangeas.jpg','','','','','','','','','',1,'2014-04-10 00:00:00',1,'2014-11-30 15:11:41');
